module Dashboard
  class OrderProductsController < DashboardController
    ...
    def cook
      ...
      render_after_cook_fail_transition
    rescue Inventory::ConsumeOrderProduct::InsufficientStockError => error
      flash[:alert] = "Unable to start preparation: #{error.message}"
      render_after_cook_fail_transition
    end
    ...
    def render_after_cook_fail_transition
      set_recent_preparations
      render "dashboard/order_products/index", status: :unprocessable_content
    end
  end
